...
4. **任何买卖建议** → 交回 `family-wealth-ips` 过闸，本 skill 不单独下单
...
| 产品 | 策略 |
|:----|:-----|
| 招商双债 / 平安瑞尚 | 存量不动收息；增量是否进权益 **先过 IPS** |
...
输出用「家人持仓分析」格式；补仓默认定投方案；**必须 IPS 标明钱池=家人名义**。
...
5. 本 skill 不绕过 IPS 直接下单。

## 相关技能

- `family-wealth-ips` — 总闸门（先过闸）
